...
// Middlewares
app.use(express.static(path.join(__dirname, "profile-login-frontend/build")));
...
app.post("/api/auth/local", async (req, res) => {
  ...
  console.log("POST /api/auth/local req.body", req.body);
  console.log("POST /api/auth/local loginRes", loginRes.data);
...
app.post("/api/auth/local/register", async (req, res) => {
  console.log("POST /api/auth/local/register", req.body);
...
app.get("*", (req, res) => {
  res.sendFile(
    path.join(__dirname + "/profile-login-frontend/build/index.html")
  );
});
